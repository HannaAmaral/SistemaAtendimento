...
namespace SistemaAtendimento.Repositories
{
    public class ClienteRepository
    {
        ...
        public void Inserir(Clientes cliente)
        {
            using (var conexao = ConexaoDB.GetConexao())
            {
                string sql = "INSERT INTO clientes (nome, email, cpf_cnpj, tipo_pessoa, telefone, celular, cep, endereco, numero, complemento," +
                    " bairro, cidade, estado, ativo) VALUES (@nome, @email, @cpf_cnpj, @tipo_pessoa, @telefone, @celular, @cep, @endereco, @numero," +
        ...
        public void Atualizar(Clientes cliente)
        {
            using (var conexao = ConexaoDB.GetConexao())
            {
                string sql = "UPDATE clientes SET nome = @nome, email = @email, cpf_cnpj = @cpf_cnpj, tipo_pessoa = @tipo_pessoa, telefone = @telefone," +
