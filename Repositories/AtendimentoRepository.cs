...
namespace SistemaAtendimento.Repositories
{
    public class AtendimentoRepository
    {
        ...
        public List<Atendimentos> Listar(string termo = "", string condicao = "")
        {
            ...
            {
                string sql = "SELECT a.*, c.nome AS cliente_nome, sa.nome AS Situacao_Atendimento, u.nome AS Usuario_nome," +
                                                                                   " c.cpf_cnpj\r\nFROM atendimentos a\r\n" +
                    ...
                    using (var linhas = comando.ExecuteReader())
                    {
                        while (linhas.Read())
                        {
                            lista.Add(new Atendimentos
                            {
                                ...
                                situacaoAtendimentoDescricao = linhas["Situacao_Atendimento"].ToString(),
